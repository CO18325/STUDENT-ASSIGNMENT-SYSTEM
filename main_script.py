...
def register_user(main_screen, win, passInput, emailInput):
    ...
    dir_id, branch, semester = mf.save_data(password, email)
    ...
    sp.stud_portal(main_screen,dir_id,branch,semester)
...
def login_user(main_screen, win, emailInput, passInput):
    ...
    dir_id, branch, semester = mf.get_user_id(email, password)
...
def main():
    ...
    Label(relief=RAISED, text='''ADVANCED ASSIGNMENT SYSTEM
